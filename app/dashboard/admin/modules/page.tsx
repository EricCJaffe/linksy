        ...
        <CardContent className="flex gap-3 pt-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300">
              As a site administrator, you can view all platform modules. To enable/disable
              modules for specific tenants, visit the tenant management page.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              it for their organization through their settings page.
            </p>
          </div>
          <div>
