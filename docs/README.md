...
> Linksy — AI-powered community resource search and referral platform for Clay County, FL.
> Built on a multi-tenant SaaS template (Next.js 14 + Supabase).

Start here:
- `docs/CONTEXT.md` — purpose, tech stack, routing, auth
- `docs/WORKFLOWS.md` — dev commands, build, deploy
